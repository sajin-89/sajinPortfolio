...
<head>
    ...
    <title>TharunKumar B - Portfolio</title>
    <style>
        body {
...
<body>
    ...
    <header>
        ...
        <img src="//storage/emulated/0/DCIM/MyAlbums/sajin/IMG_20240401_214146_571.jpg" alt="Sajin S" class="profile-picture">
    ...
    <section id="resume">
        <div class="section-content" style="text-align: center;">
            ...
            <a href="/storage/emulated/0/Download/sajin S.docx" class="download-button">Download CV</a>
        </div>
    </section>
    ...
    <section id="contact">
        <div class="section-content">
            <h2>Contact Me</h2>
            <p>Email: <a href="Sajin S">cs2301111058237@lngovernmentcollege.com</a></p>
        </div>
    </section>

    <footer>
        <p>&copy; 2025 Sajin S. All Rights Reserved.</p>
    </footer>
